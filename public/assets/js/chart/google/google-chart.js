  ...
  function drawBasic() {
    ...
    if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#ffb829", "#65c15c", "#a927f9", CubaAdminConfig.secondary, CubaAdminConfig.primary],
      };
    ...
    if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#ffb829", "#a927f9", "#65c15c", CubaAdminConfig.secondary, CubaAdminConfig.primary],
      };
    ...
    if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        colors: ["#838383", CubaAdminConfig.primary, CubaAdminConfig.secondary, "#65c15c", "#a927f9", "#ffb829", "#838383", CubaAdminConfig.primary, "#ffb829", "#65c15c", CubaAdminConfig.primary, CubaAdminConfig.secondary, "#65c15c", CubaAdminConfig.primary, "#a927f9", "#ffb829", CubaAdminConfig.primary, CubaAdminConfig.primary, "#a927f9", CubaAdminConfig.secondary, CubaAdminConfig.primary, "#65c15c"],
      };
    ...
    if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width: "100%",
        colors: [CubaAdminConfig.primary, CubaAdminConfig.secondary, "#65c15c", "#a927f9", "#ffb829"],
      };
    ...
    if ($("#area-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 400,
        colors: [CubaAdminConfig.primary, CubaAdminConfig.secondary, "#65c15c", "#ffb829"],
      };
