(function ($) {
  ...
  if ($("#annotations-chart").length > 0) {
    ...
    e.append("<div style='position:absolute;left:" + (g.left + 4) + "px;top:" + g.top + "px;color:#666;font-size:smaller'>Warming up</div>"),
      (g = f.pointOffset({
        x: 8,
        y: -1.2,
      })),
  ...
  if ($("#flot-basic-chart").length > 0) {
    ...
    $.plot("#flot-basic-chart", [a, c, d], {
      ...
      colors: ["#65c15c", "#65c15c", "#65c15c", "#65c15c"],
    });
  }
...
$(function () {
  ...
  $.each(datasets, function (key, val) {
    choiceContainer.append("<div class='checkbox checkbox-primary m-squar'><input type='checkbox' name='" + key + "' checked='checked' id='id" + key + "'></input>" + "<label for='id" + key + "'>" + val.label + "</label></div>");
  });
  ...
  function plotAccordingToChoices() {
    ...
    if (data.length > 0) {
      $.plot("#toggling-series-flot", data, {
        ...
        colors: [CubaAdminConfig.primary, "#ffb829", "#a927f9", "#65c15c", CubaAdminConfig.secondary, "#838383", "#ffb829"],
      });
    }
  }
...
$(function () {
  ...
  var data = [
    ...
    { color: "#65c15c", points: data3_points, data: data4_errors },
  ];
...
$(function () {
  ...
  $.plot("#default-pie-flot-chart", data, {
    ...
    colors: [CubaAdminConfig.primary, "#65c15c", "#ffb829", "#a927f9", "#838383", "#6c757d", CubaAdminConfig.secondary],
  });
